...
import aginsun.journey.worldgen.WorldGenBuildingsPart1;
...
public class GuiKingdom extends GuiContainer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int i, int j)
    {
        ...
        {
        	mc.renderEngine.bindTexture("/mods/MineStory/textures/guis/GuiKingdom.png");
        	int l = (width - 320) / 2;
        	int k = (height - 325) / 2;
        	drawTexturedModalRect(l, k, 0, 0, 256, 256);
        }
        {
        	mc.renderEngine.bindTexture("/mods/MineStory/textures/guis/GuiKingdomBackGround.png");
        	int l = (width - 320) / 2;
        	int k = (height - 325) / 2;
        ...
        {
        	mc.renderEngine.bindTexture("/mods/MineStory/textures/guis/GuiKingdomInventory.png");
        	int l = (width - 320) / 2;
        	int k = (height - 325) / 2;
